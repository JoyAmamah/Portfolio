...
const About = () => {
  return (
    <section className="pt-20 md:pt-32 px-6 md:px-12 mx-auto bg-slate-900 min-h-screen">
      {/* About Me Heading - Always at top */}
      <div className="mb-8 text-center md:text-left">
        ...
        <div className="w-20 h-1 bg-gradient-to-r from-blue-400 to-amber-400 rounded-full md:mx-0 mx-auto"></div>
      </div>

      {/* Image - Below heading, above text on mobile */}
      <MotionDiv
        className="w-full md:w-96 h-72 md:h-96 relative flex-shrink-0 group mx-auto md:float-right md:ml-8 md:mb-6"
      ...
      {/* Text Content - After image on mobile, wraps around image on desktop */}
      <MotionDiv
        className="flex-1"
      ...
      {/* Technologies Section - Clear float */}
