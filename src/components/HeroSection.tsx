  ...
  return (
    <section className="min-h-screen w-full flex flex-col md:flex-row items-center justify-center text-slate-200 px-4 py-10 md:px-6 bg-slate-900">
      ...
      >
        ...
        >
          I am a{" "}
          <span className="text-blue-400 font-semibold">Frontend Developer</span> that
          builds modern, interactive, and scalable web experiences. Passionate
          about <span className="text-emerald-400 font-semibold">crafting solutions</span>
          {" "}that are functional, maintainable, and
          <span className="text-amber-400 font-semibold"> delightful</span> to use.
        </motion.p>
